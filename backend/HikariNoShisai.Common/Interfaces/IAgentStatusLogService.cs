...
namespace HikariNoShisai.Common.Interfaces
{
    public interface IAgentStatusLogService
    {
        ...
        Task<StatusLogDayTimed> GetDailyGridTimedStatistics(DateTimeOffset endDate, Guid agentId = default);
        Task<List<StatusLogDayTimed>> GetMultipleDailyGridTimedStatistics(DateTimeOffset endDate, DateTimeOffset startDate, Guid agentId = default);
    }
}
